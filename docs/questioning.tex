...
structure of the executable source code that is
about to be executed with the one hat was originally intended.
If the trees diverge, the application is probably under attack.
...
one mentioned in Subsubsection~\ref{sec:tree}.
...
\scalebox{0.99}{
  ...
  & \multicolumn{2}{|c|}{Requirements\tnote{1}}
    ...
    \hline
  \multirow{3}{*}{Parse-Tree Validation}
