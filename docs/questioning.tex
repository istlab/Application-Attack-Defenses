...
references:
Point {\sc ub} (at the user's browser):~\cite{KJKV09,TNH07,NSS06,APKLM10,SPPGMMB04,ML10,YCIS07,PSC09,VDDPJ11,OWVS08,DDHPJ10,GC09,VFJKKV07,SLMS14,BV08},
Point {\sc s}t{\sc b} (en route from the server to the browser):~\cite{RDWDE07,JKK06a,JB07,NLC07,WPLKK09,JEP08},
Point {\sc e}i{\sc q} (embedded in a query en route to the database):~\cite{BWS05,SW06,PS11,HCF05,XBS06,PB05,PMP11,MS09,HO05,SMS13},
