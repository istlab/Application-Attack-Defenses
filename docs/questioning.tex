...
\section{Code Injection in Web Applications}
\label{sec:attacks}
...
{\sc dsl}s such as {\sc xp}ath~\cite{SW06,CDL07}, {\sc
...
({\sc csrf}) attacks~\cite{BJM08, LZRL09}
...
\begin{center}
\leavevmode
\includegraphics[scale=0.56]{defenses.pdf}
\end{center}
\vspace{-3mm}
...
\scalebox{0.80}{
  ...
  &   {\sc amnesia}~\cite{HO05b} & 376 & (1470,{\sc nq},0,0)\_a & {\sc nq} ({\sc s}) & {\sc sql}i \\ 
