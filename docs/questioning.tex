...
developers on the server side to introduce and enforce the applied policies.
...
injection attacks at the database level (Point i{\sc db}).
...
We group our key observations on the~34 publications that
