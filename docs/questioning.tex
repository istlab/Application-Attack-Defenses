...
\begin{abstract}
  ...
  In addition, we observe that there are protection mechanisms
...
{\it phishing}. Every {\it point} indicates a step where mechanisms
...
normal execution time of the protecting entity. As they do not provide
the times of normal executions, it not possible to move from absolute
