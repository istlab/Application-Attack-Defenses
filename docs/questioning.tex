...
\section{Application Attack Defense Mechanisms Accuracy}
% @Panos: we need to change our terminology. Instead of intrusion-detection
% systems we need to move to something like application attack defences.
% Intrusion detection is very broad and we are currently
% surveying mechanisms that detect attacks coming from a specific catefory.
