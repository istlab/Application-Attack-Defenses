...
in terms of diagnostic performance. In this cases,
all the four elements of the quadruples are not
available ({\sc na}).
...
of these mechanisms were more interested to make sure that
their mechanisms can detect known attacks than to see how
...
Moreover, we observe in some cases, that even if
...
However, their implementations are not always efficient
