...
Figure~\ref{fig:attacks} also illustrates in which transitions
...
request ({\sc transition}: {\sc p-xss} 8 \text{\textbar} {\sc n-xss} 3).
...
phishing. Every {\it point} indicates a transition where mechanisms
