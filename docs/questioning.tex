...
There are five different loci where an attack can be caught, as seen
in Figure~\ref{fig:attacks}:
\begin{itemize}
\item At the user's browser (Locus X).
\item En route from the server to the user's browser (Locus Y).
...
\item Diagnostic Performance and Computational Overhead measurements.
