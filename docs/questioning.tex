...
many mechanisms that seem to have been extensively
tested in terms of accuracy ({\sc sqlc}eck, {\sc amnesia},
...
can be a push towards the development of better mechanisms.
Apart from making the source code of such mechanisms
available, we also believe that testing them in
a production setting could propel their adoption.
