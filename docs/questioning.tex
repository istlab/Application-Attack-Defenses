...
\begin{abstract}
  ...
  the widespread adoption of attack detection mechanisms
  in practice.
...
such as SQL injection, XSS, and CSRF. Links between steps are
...
URL or page that contains a malicious request towards
a site vulnerable to {\sc csrf}.
An attacker can entice a victim to click on the URL or visit the page
...
{\sc amnesia}~\cite{HO05,HO06,HO05b} and
{\sc sd}river~\cite{MS09,MKS09,MKLS11})
...
Finally, in the {\sc amnesia}~\cite{HO05,HO06,HO05b} and
{\sc sd}river~\cite{MS09,MKS09,MKLS11} publications,
...
{\sc amnesia}~\cite{HO05,HO06,HO05b}, libAnomaly~\cite{VMV05}),
...
and {\sc sd}river~\cite{MS09,MKS09,MKLS11}),
