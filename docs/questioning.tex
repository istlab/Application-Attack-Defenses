...
innocuous events affects the calculations. In fact, if PR is the real
probability that an attack happens, the prevalence, then we
...
\item Reporting of values for True Positives ($A$), False Positives
  ...
  performance of the mechanism on environment with real attack
  profiles.
\end{itemize}
