...
references:
locus {\sc x}~\cite{KJKV09,TNH07,NSS06,APKLM10,APKLM10,SPPGMMB04,ML10,YCIS07,PSC09,VDDPJ11,OWVS08,DDHPJ10,GC09,APKLM10,VFJKKV07,SLMS14},
locus {\sc y}~\cite{RDWDE07,JKK06a,JB07,NLC07,WPLKK09,JEP08},
locus {\sc z}~\cite{BWS05,SW06,PS11,HCF05,XBS06,PB05,PMP11,MS09,HO05,HO06,HO05b,SMS13},
...
mechanisms as we sill observe), {\sc sql}check has been
...
web site"). Noxes does not deal with
JavaScript-driven {\sc xss} attacks and it is a rather
simplistic approach.
...
\end{center}
\caption{\label{fig:defect_sources}A pie showing where the
authors reffered to, to find vulnerabilities to test
their mechanims. We also provide which source was used
by which publication:
...
\subsection{Designing New Mechanisms}
