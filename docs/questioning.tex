...
application where it probably becomes a part of a value
represented by a program variable.
In the next step, the code becomes a part of a query which
...
we should mention here that there are two basic
...
% A {\sc persistent} {\sc xss} attack though would
% continue
% An {\sc xss} attack that belongs to the {\it non-persistent}
% {\sc xss} category could have followed a different path.
% This is because
