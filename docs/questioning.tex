...
attacks. For every arrow there are
corresponding transition numbers for every attack.
Every number indicates the number of the
...
{\it transitions}: {\sc p-xss} 1.1, {\sc n-xss} 1.1, {\sc csrf} 1).
...
database ({\it transitions}: {\sc dsl} 1,
{\sc p-xss} 1, {\sc n-xss} 1).
...
request ({\it transitions}: {\sc p-xss} 7, {\sc n-xss} 2).
