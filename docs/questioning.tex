...
A simple example of a dynamic language-driven attack is an input string
...
easily to false negatives. For instance, the application
...
either {\sc didafit} or {\it libAnomaly}, an attacker could bypass
them and obtain the administrator's password via email,
