...
developers in order to introduce their policies.
...
{\sc csse}~\cite{PB05} and the scheme by {\it Xu et al.}~\cite{XBS06}
apply further checks when they identify that tainted data
have reached a sink. In particular, {\sc csse} associates
