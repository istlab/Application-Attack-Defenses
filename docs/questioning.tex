...
% This increases the specificity of the stored signatures and avoids false alarms.
...
In the case of JavaScript-driven {\sc xss} attacks
the various countermeasures follow a similar pattern.
{\it {\sc swap}}~\cite{WPLKK09} follows a similar approach
with {\sc didafit} and creates a unique identifier
