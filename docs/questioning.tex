...
both on the server and the client side. It is unrealistic to expect
the average web user to go through complicated installation and
configuration procedures. Conversely, it may be possible to deliver
...
terms of accuracy ({\sc sqlc}heck, {\sc amnesia}, {\sc dsi},
...
wish to develop new countermeasures against web application
attacks.
