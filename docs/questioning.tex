...
\scalebox{0.99}{
	...
	&  	{\sc csse}~\cite{PB05} & 312 & (7,{\sc na},{\sc nq},{\sc nq})\_r & 2--10\% & {\sc sql} injection \\
...
\scalebox{0.99}{
    ...
    \hline
	\multirow{9}{*}{Runtime Tainting}
	&  	{\sc csse}~\cite{PB05} & \xmark & \xmark & \xmark \\
	&  	{\it Haldar et al.}~\cite{HCF05}  & - & - & - \\ 
	&  	{\it SecuriFly}~\cite{MLL05}  & - & - & - \\
	&  	{\it Xu et al.}~\cite{XBS06}  & - & - & - \\
    &  	{\it {\sc wasc}}~\cite{NLC07} & - & - & - \\
	&  	{\it Vogt et al.}~\cite{VFJKKV07}  & - & - & - \\
	&   {\it Noxes}~\cite{KKVJ06,KJKV09}  & - & - & - \\
	&  	{\it {\sc php} Aspis}~\cite{PMP11} & - & - & - \\
	& 	{\it Stock et al.}~\cite{SLMS14} & - & - & - \\
	\hline
	\hline      
	\multirow{3}{*}{{\sc isr}}
	&   {\it {\sc sql}rand}~\cite{BK04} & - & - & - \\
	&   {\it Noncespaces}~\cite{GC09} & - & - & - \\ 
    &   {\it x{\sc js}}~\cite{APKLM10} & - & - & - \\
	\hline
	\hline    
	\multirow{13}{*}{Policy Enforcement}
	&   {\it {\sc dsi}}~\cite{NSS06} & - & - & - \\ 
	&   {\it BrowserShield}~\cite{RDWDE07} & - & - & - \\
	&   {\it CoreScript}~\cite{YCIS07} & - & - & - \\
	&   {\it {\sc met}}~\cite{ELX07} & - & - & - \\ 
    &   {\it {\sc beep}}~\cite{TNH07} & - & - & - \\
    &   {\it {\sc soma}}~\cite{OWVS08} & - & - & - \\
	&   {\it Blueprint}~\cite{LV09} & - & - & - \\
	&   {\it Phung et al.}~\cite{PSC09} & - & - & - \\
	&   {\it WebJail}~\cite{VDDPJ11} & - & - & - \\
