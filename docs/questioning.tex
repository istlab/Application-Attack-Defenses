...
%	&   {\it {\sc cfi}~\cite{ABEL05}} & {\bf ?},{\bf ?} & 0.09--26.78\% & {\it binary code} \\
	...
	&  	{\sc csse}~\cite{PB05} & 0 & \xmark,\xmark & 2--10\% & {\sc sql} \\
    ...
    &  	{\it {\sc wasc}}~\cite{NLC07} & 0 & \xmark,\xmark & 30\% & {\sc sql}, {\sc xss} \\
	&  	{\it {\sc php} Aspis}~\cite{PMP11} & 0 & \xmark,\xmark & 2.2$\times$ & {\sc sql}, {\sc xss}, {\sc php} \\
	&  	{\it Vogt et al.}~\cite{VFJKKV07} & 322 & \xmark,{\bf ?} & {\bf ?} & {\sc xss} \\
	& 	{\it Stock et al.}~\cite{SLMS14} & 0 & 0.09\%,\xmark & 7-17\% & {\sc xss} \\
	&   {\it Noxes}~\cite{KJKV09} & 40 & {\bf ?},{\bf ?},{\bf ?},{\bf ?} & {\bf ?} & {\sc xss} \\
	...
	\hline
	\hline    
	\multirow{11}{*}{Policy Enforcement}
