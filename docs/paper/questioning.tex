...
\scalebox{0.76}{
  ...
  &   {\sc jsf}low~\cite{HBBS14} & 62 & ({\sc nq},{\sc nq},{\sc nq},{\sc nq})\_r
  &   2$\times$ ({\sc c}) & {\sc xss} \\
  &   {\sc cowl}~\cite{SYMRHKM14} & 27 & ({\sc nq},{\sc nq},{\sc nq},{\sc nq})\_r
  &   16\% ({\sc c}) & {\sc xss} \\
  &   Bauer et al.~\cite{BCJPST15} & 5 & ({\sc na},{\sc na},{\sc na},{\sc na})\_{\bf ?}
  &   average 55\% ({\sc c}) & {\sc xss} \\
  &   {\sc sif}~\cite{CVMA07} & 146 & ({\sc na},{\sc na},{\sc na},{\sc na})\_{\bf ?}
  ...
  &   Hails~\cite{GLSTMMR12} & 78 & ({\sc nq},{\sc nq},{\sc nq},{\sc nq})\_r
  &   28\% ({\sc s},{\sc c}) & {\sc sql}i, {\sc xss} \\
  &   Aeolus~\cite{CPSPBCCSL12} & 52 & ({\sc na},{\sc na},{\sc na},{\sc na})\_{\bf ?}
