...
In addition,
to address the comments of the 2nd and the 3rd reviewer,
we have included six more mechanisms,
thus making our study more extended.
Notably,
one of the mechanisms is presented in a recent
paper with less than 20 citations.
This increases the number of such papers
incorporated in our study (6).\\
...
but to highlight factors that may hinder
the widespread deployment of protection mechanisms
...
For instance,
developers could use {\sc csp}
and \textsc{sql}rand
together to deal with {\sc xss} and
...
are comprise a novel category worth mentioning.
We now refer to \textsc{xfs} attacks
at the end of Section 3 (``Exploitation Model").
